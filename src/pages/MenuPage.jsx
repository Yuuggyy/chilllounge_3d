    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            }}>{parametres?.nom_restaurant || 'Chill Lounge'}</h1>
            {!isMobile && (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          ...
          <button onClick={() => setShowPanier(true)} style={{
            ...
            whiteSpace: 'nowrap',
            boxShadow: totalItems > 0 ? `0 4px 16px rgba(0,188,212,0.35)` : 'none',
          }}>
            🛒 {!isMobile && L.panier}
            {totalItems > 0 && (
              <span style={{
      ...
      {showAppel && (
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: '0 20px 60px rgba(13,43,74,0.25)',
      ...
      {toast && (
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(13,43,74,0.25)',
