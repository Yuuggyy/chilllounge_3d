...
export default function Panier({ items, onUpdateQty, onRemove, onClose, onConfirm, isMobile }) {
  ...
  return (
    <div style={{
      ...
      background: 'rgba(13,43,74,0.50)', backdropFilter: 'blur(4px)',
      ...
      <div style={{
        ...
        boxShadow: '0 -8px 40px rgba(13,43,74,0.20)',
            ...
            <div style={{ paddingTop: 16 }}>
              {items.map((item, idx) => (
                <div key={idx} style={{
                  ...
                  padding: '12px 0', borderBottom: `1px solid rgba(0,188,212,0.12)`,
                }}>
        ...
        {items.length > 0 && (
          <div style={{
            ...
            <button onClick={handleSubmit} disabled={loading} style={{
              ...
              boxShadow: `0 4px 20px rgba(13,43,74,0.25)`,
